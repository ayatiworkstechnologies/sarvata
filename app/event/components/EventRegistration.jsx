...
export default function EventRegistration() {
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-black/5 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] p-10 md:p-16 flex flex-col md:flex-row items-stretch justify-between gap-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="mb-8">
              ...
              <h2 className="text-3xl font-extrabold text-foreground tracking-tight">For individual Registrations</h2>
            </div>

            <div className="mb-8 relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-primary to-secondary rounded-2xl blur opacity-20 transition duration-1000 group-hover:opacity-40"></div>
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSekOlTq1KsN9sDV1oapFQ57EGlcyCi6MQCvq2HFaZoywABrDA/viewform" target="_blank" rel="noopener noreferrer" className="relative block w-full">
                <AnimatedButton variant="primary" className="w-full justify-center shadow-xl">
  ...
  {/* Divider */}
  <div className="h-px w-full bg-gradient-to-r from-transparent via-black/10 to-transparent"></div>
  ...
  <div className="flex flex-col justify-center">
    ...
    <div className="mb-8 relative">
      ...
      <a
        href="https://docs.google.com/forms/d/e/1FAIpQLSekOlTq1KsN9sDV1oapFQ57EGlcyCi6MQCvq2HFaZoywABrDA/viewform"
        target="_blank"
        rel="noopener noreferrer"
        className="relative block w-full"
      >
