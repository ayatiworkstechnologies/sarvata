...
export default function MentalHealthPage() {
  const coverage = [
    {
      ...
      description: "In-the-moment techniques—breathing, grounding, mindfulness—they can use during tests, performances, overwhelming moments."
    },
    {
      title: "Understanding Emotions",
      description: "Identifying feelings, building self-awareness, recognizing patterns."
    },
    {
      title: "Building Resilience",
      description: "Growth mindset, self-compassion, knowing when asking for help is brave."
    },
    {
    ...
    },
    {
      ...
      description: "Perfectionism, workload management, recognizing when pressure crosses into harm."
    }
  ];
  ...
  const implementationDetails = [
    ...
    { label: "Coordination with counseling", value: "Work closely with your counseling team to align messaging" },
    { label: "Teacher support", value: "Follow-up discussion guides and resources" },
    { label: "Parent component", value: "Optional parent session on supporting teens' mental health" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-20 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-4 text-muted text-[16px] leading-relaxed">
                 <p className="font-medium text-foreground">Safe space. No forced sharing. Practical tools, not just awareness. Normalizing struggles without catastrophizing.</p>
                 <p><strong className="text-foreground">Age-appropriate:</strong> Middle school focuses on emotional literacy. High school addresses complex pressures around identity and future.</p>
              </div>
            </div>
