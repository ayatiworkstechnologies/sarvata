  ...
  return (
    <main className="bg-white">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative p-10 md:p-16 rounded-[3rem] bg-soft-bg border border-border overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
                <div>
                  <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-8">The Gap</h2>
                  <div className="space-y-6 text-muted text-lg leading-relaxed">
                    <p>Well-intentioned policies sit unimplemented. Some students consistently fall through cracks.</p>
                    <p>The gap isn’t about commitment. It’s about translating values into coherent school-wide systems while managing everything else.</p>
                  </div>
                </div>
                ...
                >
                  <p className="text-foreground text-xl font-semibold leading-relaxed">
                    An inclusion audit provides what aspiration cannot: <span className="text-primary italic font-bold">objective data about current reality and strategic pathways forward.</span>
                  </p>
                </motion.div>
              </div>
            </div>
      ...
      <TestimonialsSection
        ...
        testimonials={[
          {
            quote: "The inclusion audit gave us what our internal teams couldn't: an objective, systemic view of our gaps. The resulting roadmap is now our primary strategic document.",
            author: "Dr. Aruna V., Head of School"
          },
          {
            quote: "Finally, a framework that moves beyond compliance toward genuine culture change. The audit was the catalyst we needed to align our practice with our mission.",
