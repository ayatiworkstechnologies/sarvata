      ...
      <MainHero
        title={
          <>
            ...
            <span className="text-[#6B4A8E]">informed,</span> <br />
            <span className="text-[#D9A63A]">confident</span>{" "}
            <span className="text-[#6B4A8E]">parenting</span>
          </>
        }
        breadcrumbs={[
        ...
        webImage="/banners/parent-web.png"
        mobileImage="/banners/parent-mob.png"
      />
