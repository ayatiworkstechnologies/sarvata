...
export default function FreeResourcesPage() {
  const resources = [
    ...
    },
    {
      ...
      description:
        "Question stems organized by purpose, grade-band adaptations, sentence starters, protocols for independent use.",
    ...
    },
    {
      ...
      description:
        "Observable indicators, prompts for noticing abilities beyond tests, note-taking template, conversation guide.",
    ...
    },
    {
      ...
      description:
        "Questions for when/where to differentiate, three-tier framework, time-saving approaches, troubleshooting.",
    ...
    },
    {
      ...
      description:
        "15 fast techniques, guidance on what each reveals, question stems, flexible grouping strategies.",
    ...
    },
    {
      ...
      description:
        "Framework for identifying independence skills, lesson template, gradual release model, troubleshooting guide.",
    ...
    <main className="bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="p-6 h-full rounded-2xl bg-secondary/10 border border-secondary/20">
                ...
                <p className="text-sm text-muted">
                  Make them fit your specific context and students.
                </p>
              </div>
              <div className="p-6 h-full rounded-2xl bg-secondary/10 border border-secondary/20">
                ...
                <p className="text-sm text-muted">
                  Pass them along to colleagues who might benefit.
                </p>
              </div>
              <div className="p-6 h-full rounded-2xl bg-secondary/10 border border-secondary/20">
                <h3 className="font-bold text-foreground mb-2">Start Small</h3>
                <p className="text-sm text-muted">
                  Focus on one pressing challenge at a time.
                </p>
              </div>
            </div>
          </div>
      ...
      <TestimonialsSection
        ...
        testimonials={[
          {
            quote:
              "Sharing these resources freely shows how much Sarvata cares about classroom transformation. The choice-board kit alone saved me hours of planning.",
            author: "P. Sharma, Educator",
          },
          {
            quote:
              "These aren't just templates; they are deep frameworks that shift how you think about teaching. I use the metacognitive stems in every lesson now.",
