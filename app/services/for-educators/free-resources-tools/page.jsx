...
export const metadata = {
  title: "Free Resources & Tools - For Educators | Sarvata",
  description:
    "Tools for Your Practice, Freely Shared. Resources we’ve developed and used in real classrooms. Download, adapt, share with colleagues. No registration required.",
};
            ...
            {resources.map((resource, i) => (
              ...
              >
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-foreground mb-4 leading-tight">{resource.title}</h3>
                  ...
                  <div className="mb-8 p-4 bg-primary/5 rounded-xl border border-primary/10">
                    <strong className="text-foreground text-sm block mb-1">When to use:</strong>
                    <span className="text-muted text-sm">{resource.whenToUse}</span>
                  </div>
                </div>
                ...
                <div className="mt-auto">
                  <a
                    href={resource.link}
                    className="inline-flex w-full items-center justify-center gap-2 bg-primary text-white py-3.5 px-6 rounded-full font-semibold hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20"
                  >
                    Download PDF
